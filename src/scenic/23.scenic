...
behavior EgoBehavior(trajectory):
    ...
    interrupt when withinDistanceToAnyObjs(self, globalParameters.SAFETY_DIST) and (bike in network.drivableRegion) and flag:
        flag = False
...
bike = Bicycle right of tempSpawnPt by 5,
